...
function Edit({
  ...
  const [parentTerms, setParentTerms] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useState)([]);
  ...
  const renderTerms = () => {
    if (outputVariant === 'list') {
      ...
      return terms.map(term => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        key: term.id,
        className: "flex-item"
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select a parent term', 'taxonomy-list-block'),
    value: parentTermId,
    options: [{
      value: 0,
  ...
  }), includeImage && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToggleControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Set as background image', 'taxonomy-list-block'),
    checked: setAsBackground,
    onChange: value => {
      setAttributes({
        setAsBackground: value
      });
    }
  })))), renderTerms());
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunktaxonomy_list_block"] = globalThis["webpackChunktaxonomy_list_block"] || [];
